...
namespace M3Reports
{
    ...
    public class ReportMonitoringFacade : ReportDataProvider
    {
        public ReportMonitoringFacade(string ip, int port, string login, string password, string incidentsGetJSON)
            : base(ip, port, login, password, incidentsGetJSON)
        {
            this.report = new ReportMonitoring();
